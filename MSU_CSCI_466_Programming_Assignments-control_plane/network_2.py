...
class Router:
    ...
    def __init__(self, name, cost_D, max_queue_size):
        ...
        for item in list(cost_D):
            for interface in list(self.cost_D[item]):
                temp = cost_D[item][interface]
                self.iList.update({interface:temp})
                self.rt_tbl_D.update({item:{self.name:temp}})
